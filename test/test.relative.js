...
asyncTest('./', function() {
    _ent.use('foo/bar/egg', function(egg) {
...
asyncTest('../', function() {
    _ent.use('foo/bar/egg/sided', function(sided) {
...
asyncTest('../../', function() {
    _ent.use('foo/bar/egg/sided/spiced', function(spiced) {
...
asyncTest('../../../', function() {
    _ent.use('foo/bar/egg/sided/spiced/chopped', function(chopped) {
